...
class ReactNativeActivity : ReactActivity(), DefaultHardwareBackBtnHandler,
  ...
  override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
    ...
    if (ReactNativeBrownfield.shared.reactNativeHost.hasInstance()) {
      ReactNativeBrownfield.shared.reactNativeHost.reactInstanceManager?.onActivityResult(
        this,
        requestCode,
        resultCode,
        data
