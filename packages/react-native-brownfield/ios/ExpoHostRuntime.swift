    ...
    final class ExpoHostRuntime {
        ...
        private func configureDevLoadingView(with bundleURL: URL? = nil) {
                ...
                let shouldDisableDevLoadingView =
                    ...
                    && (resolvedBundleURL?.isFileURL ?? false)

                BrownfieldDevLoadingViewBridge.setEnabled(
                    !shouldDisableDevLoadingView
                )
            #endif
        }
        ...
        func view(
            ...
            #if EXPO_SDK_GTE_55  // this define comes from the Brownfield Expo config plugin
                return (reactNativeFactory as? ExpoReactNativeFactory)?
                    .recreateRootView(
            ...
            do {
                ...
                if let overriddenURL = bundleURLOverride?() {
                    ...
                    if !isDebug,
                        ...
                        let launchAssetURL = AppController.sharedInstance
                            .launchAssetUrl()
                    {
