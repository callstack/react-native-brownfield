...
2. Drag these files into your native iOS app's Xcode project:
   ...
   - **`React.xcframework`** and **`ReactNativeDependencies.xcframework`** - they are emitted in supported configurations, as described in [React Native Prebuilts](#react-native-prebuilts) section
