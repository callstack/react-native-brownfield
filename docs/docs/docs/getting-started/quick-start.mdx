...
The `@callstack/react-native-brownfield` package includes a [**built-in CLI**](/docs/cli/introduction) that handles the complex process of packaging your React Native app into native framework artifacts.
