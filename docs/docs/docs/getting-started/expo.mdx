...
- `targetSdkVersion` (`number`, optional, Expo SDK below 58 only)
  - Target Android SDK version used to build the library. Ignored on Expo SDK 58 and later.
- `compileSdkVersion` (`number`, default: `37` on Expo SDK 58 and later, otherwise `35`)
