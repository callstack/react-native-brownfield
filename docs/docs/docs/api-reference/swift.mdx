...
You can find an example consumer iOS app [here](https://github.com/callstack/react-native-brownfield/tree/main/apps/iOSApp) and the consumed library module [here](https://github.com/callstack/react-native-brownfield/tree/main/apps/RNApp/ios).
