...
[[ReactNativeBrownfield shared] startReactNative:^(JSBundleTimings *timings){
    NSLog(@"React Native started jsBundleLoadTime=%@ jsBundleEvaluationTime=%@", timings.jsBundleLoadTime, timings.jsBundleEvaluationTime);
}];
```
...
[[ReactNativeBrownfield shared] startReactNativeWithLaunchOptions:launchOptions
    ...
    NSLog(@"React Native bundle loaded jsBundleLoadTime=%@ jsBundleEvaluationTime=%@", timings.jsBundleLoadTime, timings.jsBundleEvaluationTime);
}];
```
