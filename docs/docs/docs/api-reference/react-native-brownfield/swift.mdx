...
| ---------------- | -------------------------- | ----------------------------------------------------------------------- |
| `loadMs`         | `RCTPLScriptDownload`      | Metro HTTP in Debug, file read in Release.                              |
| `executeMs`      | `RCTPLScriptExecution`     | Time to evaluate the bundle. Do not add this to `instanceInitMs`.       |
| `instanceInitMs` | `RCTPLReactInstanceInit`   | Hermes/instance bring-up until download starts.                         |
...
ReactNativeBrownfield.shared.startReactNative(onBundleLoaded: { timings in
  print("React Native started loadMs=\(String(describing: timings.loadMs)) executeMs=\(String(describing: timings.executeMs))")
})
```
...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ReactNativeBrownfield.shared.startReactNative { timings in
      print("React Native bundle loaded loadMs=\(String(describing: timings.loadMs))")
    }
    return true
  }
}
