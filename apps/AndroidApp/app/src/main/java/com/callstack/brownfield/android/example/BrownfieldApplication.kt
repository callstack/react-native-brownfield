 ...
 * ReactNativeHostManager or ReactNativeBrownfield; since this app is a testing app and we are
 * using Detox as E2E testing driver, we are making that trade-off.
 */
