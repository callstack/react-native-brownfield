...
- You can run `./brownfield/gradlew -p brownfield lint` to auto-format and detect linting issues, or use the root workspace script `yarn run gradle-plugin:lint`
